...
exports.calcThaiTax = calcThaiTax;
exports.calcOTPay = calcOTPay;
exports.calcSso = calcSso;
...
function calcThaiTax(annualIncome, annualSso = 0, annualPvf = 0) {
    ...
    let tax = 0;
    for (const b of exports.TAX_BRACKETS) {
        if (taxable <= b.min)
            break;
...
function calcOTPay(emp, otHours, isHoliday = false, shift, settings = null) {
...
function calcSso(salary, settings = null) {
